...
class AirbnbSpider(scrapy.Spider):
    ...
    cookies = {
        ...
        '_csrf_token': 'V4%24.airbnb.co.uk%24xPMq8Y7Iu5Y%24C6veBngwzVAmZ1W7qcxPd-P2j1vjKZ4Cpj6e3qBp3P4%3D',
    ...
    def parse_id(self, response):
        ...
        for restaurant in restaurants:
            yield scrapy.Request(url='https://www.airbnb.co.uk/api/v2/place_activities/{0}?key=d306zoyjsyarp7ifhu67rjxn52tv0t20&currency=USD&locale=en&_format=for_spa_activity_pdp_web'.format(restaurant.get('id')),
                                 callback=self.parse)
