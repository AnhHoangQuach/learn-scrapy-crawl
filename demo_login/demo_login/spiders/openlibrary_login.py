...
# Just one quick remark here, if the form does require JavaScript then you
# can't use the FormRequest class, so as an alternative solution you have to use another class
# called SplashFormRequest which does have the same methods as in the FormRequest class and takes the same arguments.
